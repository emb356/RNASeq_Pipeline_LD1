...
USAGE="Usage: $0 -i RunDir  -o OutDir  -s setting [-n num_threads] [-m num of mismatches to be allowed in barcodes] [-c #reads to be placed in each fastq file] [-F flag to force demultiplexing of run w/o post-processing] "
